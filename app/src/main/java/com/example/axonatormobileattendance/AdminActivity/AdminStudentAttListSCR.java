...
public class AdminStudentAttListSCR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_student_att_list_s_c_r);
        ...
        st_att_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AdminStudentAttListSCR.this, AdminDashboard.class));
                finish();
            }
        });
    ...
    private void ShowMonthAttendance()
    {
        ...
        zon1.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                {
                    Toast.makeText(AdminStudentAttListSCR.this, "No Attendance of this month...!", Toast.LENGTH_SHORT).show();
                }
